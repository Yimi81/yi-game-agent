...
from yi_game_agent import agents
from .agents import AgentBase
from .logging import LOG_LEVEL
from .constants import _DEFAULT_SAVE_DIR, _DEFAULT_LOG_LEVEL, _DEFAULT_CACHE_DIR
from .manager import YIManager
...
def init(
    ...
    """
    # Init the runtime
    YIManager.get_instance().initialize(
...
def state_dict() -> dict:
    ...
    return YIManager.get_instance().state_dict()


def print_llm_usage() -> dict:
    """Print the usage of LLM."""
    return YIManager.get_instance().monitor.print_llm_usage()
